...
const dictionary: Dictionary = {
  ...
  appScreens: {
    title: "Van zoeken naar geboekt in minuten",
    subtitle:
      "Kijk hoe de app je van artiesten bekijken naar een bevestigde afspraak brengt.",
    cta: "Download de app",
    note: "Voor iPhone en Android",
    screens: [
  ...
  contactForm: {
    ...
    sending: "Versturen",
    successNote: "Bedankt voor je bericht. We reageren zo snel mogelijk.",
    errorNote: "Er ging iets mis bij het versturen. Probeer het opnieuw of mail ons direct op",
  },
  cookie: {
    ...
    prefsIntro: "Kies met welke cookies je akkoord gaat. In ons cookiebeleid staat welke cookies we gebruiken.",
    closeAria: "Sluiten",
    save: "Keuze opslaan",
    necessaryLabel: "Strikt noodzakelijk",
    necessaryDesc: "Essentieel voor de basisfunctionaliteit van onze website en kan niet worden uitgeschakeld.",
    analyticsLabel: "Analyses",
    analyticsDesc: "Hiermee kunnen we het webverkeer volgen om onze diensten te verbeteren.",
    marketingLabel: "Gerichte reclame",
    marketingDesc: "Hiermee kunnen wij en derden advertenties aanbieden die voor jou relevant zijn.",
    manageLabel: "Cookievoorkeuren",
  },
  footer: {
