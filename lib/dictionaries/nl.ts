...
const dictionary: Dictionary = {
  ...
  cookie: {
    ...
    necessaryDesc: "Nodig om de site te laten werken. Staat altijd aan.",
    analyticsLabel: "Analytisch",
    analyticsDesc: "Helpt ons begrijpen hoe de site wordt gebruikt.",
    marketingLabel: "Marketing",
    marketingDesc: "Meet advertenties, zoals de Meta Pixel.",
